                        ...
                        <div class="panel panel-danger">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="AdminLogin" method="post">
                                    ...
                                    <div class="form-group">
                                        <label>Password.:</label> <input type="password" name="upass" class="form-control" required="">
                                    </div>
                                    <input type="submit" value="Admin Login" onclick="alert('Check Before Submit')" class="btn btn-primary">
